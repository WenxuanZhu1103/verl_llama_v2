#!/bin/bash
#SBATCH --job-name=my_llama_3.2_1b_2048
#SBATCH --mem=64G
#SBATCH --nodes=1
...
#SBATCH --output=logs/my_llama_3.2_1b_2048_%A_%a.out
#SBATCH --error=logs/my_llama_3.2_1b_2048_%A_%a.err
...
PYTHONPATH=.. python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='my_llama_3.2_1b_2048' \
