#!/bin/bash
#SBATCH --job-name=llama_3.1_8b_grpo_lora_2048
#SBATCH --mem=64G
#SBATCH --nodes=1
...
#SBATCH --output=logs/llama_3.1_8b_grpo_lora_2048_%A_%a.out
#SBATCH --error=logs/llama_3.1_8b_grpo_lora_2048_%A_%a.err
...
PYTHONPATH=.. python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='llama_3.1_8b_grpo_lora_2048_new' \
