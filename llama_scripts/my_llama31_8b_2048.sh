#!/bin/bash
#SBATCH --job-name=my_llama_3.1_8b_2048_lr3e-7
#SBATCH --mem=192G
#SBATCH --nodes=1
...
#SBATCH --output=logs/my_llama_3.1_8b_2048_lr3e-7_%A_%a.out
#SBATCH --error=logs/my_llama_3.1_8b_2048_lr3e-7_%A_%a.err
...
PYTHONPATH=.. python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='my_llama_3.1_8b_2048_lr3e-7' \
