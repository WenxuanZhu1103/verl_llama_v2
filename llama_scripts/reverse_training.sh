#!/bin/bash
#SBATCH --job-name=reverse_training_grpo_llama_3.2_1b
#SBATCH --mem=64G
#SBATCH --nodes=1
...
#SBATCH --output=logs/reverse_training_grpo_llama_3.2_1b_%A_%a.out
#SBATCH --error=logs/reverse_training_grpo_llama_3.2_1b_%A_%a.err
...
train_path=/ibex/project/c2261/wenxuan/projects/verl_llama/data/my_data_new/train_data/step_bench_for_train_deduplicated.parquet
...
val_path="[$val_path_1,$val_path_2,$val_path_3,$val_path_4,$val_path_5]"
...
PYTHONPATH=.. python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='reverse_training' \
    trainer.experiment_name='reverse_training_grpo_llama_3.2_1b' \
