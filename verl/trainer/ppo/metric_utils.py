...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> Dict[str, Any]:
    ...
    metrics = {
        ...
        **(
        ...
        "response/length/train_response_length_mean": torch.mean(response_length).detach().item(),
        "response/length/train_response_length_std": torch.std(response_length).detach().item(),
        # response length
