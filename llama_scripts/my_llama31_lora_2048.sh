#!/bin/bash
#SBATCH --job-name=llama_3.1_8b_my_grpo_v20_lora_2048
#SBATCH --mem=64G
#SBATCH --nodes=1
...
#SBATCH --output=logs/llama_3.1_8b_my_grpo_v20_lora_2048_%A_%a.out
#SBATCH --error=logs/llama_3.1_8b_my_grpo_v20_lora_2048_%A_%a.err
...
train_path=/ibex/project/c2261/wenxuan/projects/verl_llama/data/my_data_new/train_data/open_rs_modified.parquet
...
PYTHONPATH=.. python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='llama_rl' \
    trainer.experiment_name='llama_3.1_8b_my_grpo_v20_lora_2048' \
