#!/bin/bash
#SBATCH --job-name=my_llama_3.2_1b_2048_smts_rm_v21_paper_param
#SBATCH --mem=64G
#SBATCH --nodes=1
...
#SBATCH --output=logs/my_llama_3.2_1b_2048_smts_rm_v21_paper_param_%A_%a.out
#SBATCH --error=logs/my_llama_3.2_1b_2048_smts_rm_v21_paper_param_%A_%a.err
...
train_path=/ibex/project/c2261/wenxuan/projects/verl_llama/data/my_data_new/train_data/gsm8k_train_modified.parquet
...
PYTHONPATH=.. python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.importance_sampling_mode="response_multiply" \
    algorithm.use_kl_in_reward=False \
    trainer.critic_warmup=0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='llama_rl_new' \
    trainer.experiment_name='my_llama_3.2_1b_2048_smts_rm_v21_paper_param' \
